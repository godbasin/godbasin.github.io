...
/***/ function(module, exports, __webpack_require__) {
	...
	var account_controller_1 = __webpack_require__(311);
	// 注入指令
	var alertMsg_directive_1 = __webpack_require__(312);
	var selectDate_directive_1 = __webpack_require__(314);
	var selectDateInterval_directive_1 = __webpack_require__(315);
	var selectTime_directive_1 = __webpack_require__(316);
	var sidebar_directive_1 = __webpack_require__(317);
	var onEnter_directive_1 = __webpack_require__(318);
	var onEsc_directive_1 = __webpack_require__(319);
	var onFocusLost_directive_1 = __webpack_require__(320);
	// 注入服务
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var AlertMsg_1 = __webpack_require__(307);
	var BasicTools_1 = __webpack_require__(308);
	var angular = __webpack_require__(301);
	var LoginCtrl = (function () {
	    ...
	    LoginCtrl.prototype.submitForm = function () {
	        ...
	        AlertMsg_1.SetAlertMsg({ text: '确认？' }).then(function () {
	            // 登录中提示
...
/***/ function(module, exports) {
	...
	var AlertMsgService = (function () {
	    ...
	    // 获取是否设置
	    AlertMsgService.prototype.getIsSet = function () {
	        return this.isSet;
	    };
	    // 获取设置的数据
	    AlertMsgService.prototype.getParams = function () {
	        return this.params;
	    };
	    // 设置参数，并返回promise
	    AlertMsgService.prototype.setMsg = function (params) {
	        var _this = this;
	        this.isSet = true;
	        this.params = params;
	    ...
	    // reject并清除数据
	    AlertMsgService.prototype.msgReject = function () {
	    ...
	    // resolve并清除数据
	    AlertMsgService.prototype.msgResolve = function () {
	    ...
	    // 清除数据
	    AlertMsgService.prototype.clearMsg = function () {
	        this.params = undefined;
	        this.isSet = false;
	    };
	    return AlertMsgService;
	}());
	var AlertMsg = new AlertMsgService();
	var getParams = AlertMsg.getParams, getIsSet = AlertMsg.getIsSet, setMsg = AlertMsg.setMsg, msgReject = AlertMsg.msgReject, msgResolve = AlertMsg.msgResolve;
	exports.GetAlertMsgParams = getParams;
	exports.isAlertMsgSet = getIsSet;
	exports.SetAlertMsg = setMsg;
	exports.AlertMsgReject = msgReject;
	exports.AlertMsgResolve = msgResolve;
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var AlertMsg_1 = __webpack_require__(307);
	var KeyUp_1 = __webpack_require__(313);
	Object.defineProperty(exports, "__esModule", { value: true });
	/*
	 * [alert-msg]
	 *
	    ...
	    ngModule.directive('alertMsg', ['$parse', function ($parse) {
	            return {
	                ...
	                link: function (scope, element, attrs) {
	                    // watch是否设置，来控制是否显示
	                    scope.$watch(AlertMsg_1.isAlertMsgSet, function (newValue, oldValue) {
	                        if (newValue === true) {
	                            // 获取相应的现实数据
	                            scope.params = AlertMsg_1.GetAlertMsgParams();
	                            // 设置按下Esc键时默认取消
	                    ...
	                    scope.close = function () {
	                        AlertMsg_1.AlertMsgReject();
	                        scope.params = undefined;
	                    };
	                    // 确认时，调用resolve
	                    scope.submit = function () {
	                        AlertMsg_1.AlertMsgResolve();
	                        scope.params = undefined;
	                    };
	                }
	            };
